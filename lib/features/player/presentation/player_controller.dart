...
import 'player_subtitle_manager.dart' as subtitle_manager;
...
class PlayerController extends Notifier<PlayerState> {
  ...
  ) => subtitle_manager.effectiveExternalSubtitles(
    streamSubtitles,
    _userAddedExternalSubtitles,
  );
  ...
  Future<void> _cleanupSubtitleTempFiles() =>
      subtitle_manager.cleanupSubtitleTempFiles(
        onError: (e) {
  ...
  Future<void> applySubtitleSettings() async {
    ...
    final native = _player.platform;
    if (native is NativePlayer) {
      await subtitle_manager.applySubtitleSettings(
        native,
